...
public class ResidentReportedIssueMapper implements RowMapper<ResidentReportedIssue> {
    @Override
    public ResidentReportedIssue mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        residentReportedIssue.setResidentReportedIssueId(rs.getInt("issue_id"));
